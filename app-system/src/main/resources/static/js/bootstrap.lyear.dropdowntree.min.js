/**
 * 下拉树形选择(可多选)
 * 基于Bootstrap v3.3.7，且配合Light Year Admin使用
...
;(function($, window, document, undefined) {
    ...
    var lyearDropdownTree = function(ele, opt) {
        ...
        this.bsVersion = "undefined" == typeof $.fn.modal.Constructor.VERSION ? "3" : /4\.4\.[0,1]/.test($.fn.modal.Constructor.VERSION) ? "4" : "3";
        ...
        this.renderData = function(data, element) {
            for (var i = 0; i < data.length; i++) {
                if (!element.is('li')) {
                    ...
                    element.find('ul').append('<li id="lyearDropdownTree'+data[i].id+'"><a href="#!" data-id="'+data[i].id+'">'+data[i].name+'</a>');
                }
